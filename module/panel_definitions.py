...
def get_panel_def_japan(ds_dict):
    """
    日本全域6段パネル定義（GSM3段＋MSM3段）for 8列パネル
    ds_dict: 必要変数を全て個別openしたdict
    """
    ...
    return [
        ...
        (plot_500hpa_vorticity, {
            "vo": ds_dict["500hpa_vo"],
            "t": ds_dict["500hpa_t"],
        }, "500hPa渦度"),
        # 3段目：700hPa湿数+500hPa気温
        (plot_700hpa_dindex_500hpa_temp, {
            "t_700": ds_dict["700hpa_t"],
            "r_700": ds_dict["700hpa_r"],
            "t_500": ds_dict["500hpa_t"],
        }, "700hPa湿数+500hPa気温"),
        # 4段目：850hPa温度・風+700hPa鉛直流
        (plot_850hpa_temp_wind_700hpa_w, {
            "t_850": ds_dict["850hpa_t"],
            "u_850": ds_dict["850hpa_u"],
            "v_850": ds_dict["850hpa_v"],
            "w_700": ds_dict["700hpa_w"],
        }, "850hPa温度・風+700hPa鉛直流"),
        # 5段目：850hPa θe流線
        (plot_850hpa_thetae_stream, {
            "t_850": ds_dict["850hpa_t"],
            "r_850": ds_dict["850hpa_r"],
        }, "850hPa θe流線"),
        # 6段目：地上気圧・風・降水量
